...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/chanimages
```

A live public deployment of this template is available at [https://chanimages.templates.workers.dev](https://chanimages.templates.workers.dev)
